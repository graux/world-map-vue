...
describe('getDynamicMapCss', () => {
  ...
  const expectedResult = [
    '.world-map-vue #US { fill: 0 hex; }',
    '.world-map-vue #CA { fill: 0.30000000000000004 hex; }',
    '.world-map-vue #GB { fill: 0.4 hex; }',
    '.world-map-vue #IE { fill: 1 hex; }'
  ]
...
describe('getBaseCss', () => {
  ...
  const expectedResult = '.world-map-vue .land{fill:foo;stroke:bar;}'
